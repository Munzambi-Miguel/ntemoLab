            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '192.168.52.10')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'cn=Users,dc=kinsari,dc=com'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'SERVER\laravel.admin'),
                'password' => env('LDAP_PASSWORD', 'Angola2023!'),
