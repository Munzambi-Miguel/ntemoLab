...
return [
    ...
    */
    ...
    'identifiers' => [
        ...
        */
        ...
        /*
         * Está a localizar pelo email de login da AD (userprincipalname)
         * Para localizar pela conta (ex. jose.ferreira) , trocar por 'sAMAccountName'
         */
        'ldap' => [
    ...
    */
    ...
    /*
     * Esta a sincronizar o email de login da AD (userprincipalname)
     * Para sincronizar pelo username , trocar por sAMAccountName
     */
    'sync_attributes' => [
